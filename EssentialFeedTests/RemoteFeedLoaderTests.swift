...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliverItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "htttp://a-url.com")!)
        let item1JSON = [
            "id": item1.id.uuidString,
            "image": item1.imageURL.absoluteString
        ]
        let item2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "htttp://another-url.com")!)
        let item2JSON = [
