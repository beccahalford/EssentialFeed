...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliverItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = makeItem(uuid: UUID(), imageURL: URL(string: "htttp://a-url.com")!)

        let item2 = makeItem(uuid: UUID(), description: "a description", location: "a location", imageURL: URL(string: "htttp://another-url.com")!)
    ...
    func test_load_doesNotDeliverResultAfterSUTInsttanceHasBeenDeallocated() {
